...
module ae350_vcpu_cluster_subsystem (
    ...
    hart4_wakeup_event,
    hart4_core_wfi_mode,
    hart4_dcache_disable_init,
    hart4_icache_disable_init,
    hart4_nmi,
    hart4_reset_vector,
    hart5_wakeup_event,
    hart5_core_wfi_mode,
    hart5_dcache_disable_init,
    hart5_icache_disable_init,
    hart5_nmi,
    hart5_reset_vector,
    hart6_wakeup_event,
    hart6_core_wfi_mode,
    hart6_dcache_disable_init,
    hart6_icache_disable_init,
    hart6_nmi,
    hart6_reset_vector,
    hart7_wakeup_event,
    hart7_core_wfi_mode,
    hart7_dcache_disable_init,
    hart7_icache_disable_init,
    hart7_nmi,
    hart7_reset_vector,
    dmactive,
    dmi_haddr,
...
output [5:0] hart4_wakeup_event;
output hart4_core_wfi_mode;
input hart4_dcache_disable_init;
input hart4_icache_disable_init;
input hart4_nmi;
input [(VALEN - 1):0] hart4_reset_vector;
output [5:0] hart5_wakeup_event;
output hart5_core_wfi_mode;
input hart5_dcache_disable_init;
input hart5_icache_disable_init;
input hart5_nmi;
input [(VALEN - 1):0] hart5_reset_vector;
output [5:0] hart6_wakeup_event;
output hart6_core_wfi_mode;
input hart6_dcache_disable_init;
input hart6_icache_disable_init;
input hart6_nmi;
input [(VALEN - 1):0] hart6_reset_vector;
output [5:0] hart7_wakeup_event;
output hart7_core_wfi_mode;
input hart7_dcache_disable_init;
input hart7_icache_disable_init;
input hart7_nmi;
input [(VALEN - 1):0] hart7_reset_vector;
output dmactive;
input [8:0] dmi_haddr;
...
wire core2_clk;
wire core2_dcu_clk;
wire [63:0] core2_hart_id;
wire core2_l2_clk;
wire core2_l2_reset_n;
wire core2_lm_clk;
wire core2_reset_n;
wire core2_slv1_clk;
wire core2_slv1_clk_en;
wire core2_slv_clk;
wire core2_slv_clk_en;
wire core2_slvp_reset_n;
wire hart2_ueip;
wire vpu2_clk;
wire vpu2_hvm_clk;
wire vpu2_vace_clk;
...
wire vpu2_vmac_clk;
wire vpu2_vmask_clk;
wire vpu2_vpermut_clk;
wire vpu2_vsp_clk;
wire hart2_meiack;
wire hart2_seiack;
wire hart2_stoptime;
wire vpu2_clk_en;
wire vpu2_vace_clk_en;
wire vpu2_valu_clk_en;
wire vpu2_vdiv_clk_en;
wire vpu2_vfdiv_clk_en;
wire vpu2_vfmis_clk_en;
wire vpu2_vlsu_clk_en;
wire vpu2_vmac_clk_en;
wire vpu2_vmask_clk_en;
wire vpu2_vpermut_clk_en;
wire vpu2_vsp_clk_en;
wire hart2_debugint;
wire hart2_meip;
wire hart2_msip;
wire hart2_mtip;
wire hart2_resethaltreq;
wire hart2_seip;
wire core3_clk;
wire core3_dcu_clk;
wire [63:0] core3_hart_id;
wire core3_l2_clk;
wire core3_l2_reset_n;
wire core3_lm_clk;
wire core3_reset_n;
wire core3_slv1_clk;
wire core3_slv1_clk_en;
wire core3_slv_clk;
wire core3_slv_clk_en;
wire core3_slvp_reset_n;
wire hart3_ueip;
wire vpu3_clk;
wire vpu3_hvm_clk;
wire vpu3_vace_clk;
...
wire vpu3_vmac_clk;
wire vpu3_vmask_clk;
wire vpu3_vpermut_clk;
wire vpu3_vsp_clk;
wire hart3_meiack;
wire hart3_seiack;
wire hart3_stoptime;
wire vpu3_clk_en;
wire vpu3_vace_clk_en;
wire vpu3_valu_clk_en;
wire vpu3_vdiv_clk_en;
wire vpu3_vfdiv_clk_en;
wire vpu3_vfmis_clk_en;
wire vpu3_vlsu_clk_en;
wire vpu3_vmac_clk_en;
wire vpu3_vmask_clk_en;
wire vpu3_vpermut_clk_en;
wire vpu3_vsp_clk_en;
wire hart3_debugint;
wire hart3_meip;
wire hart3_msip;
wire hart3_mtip;
wire hart3_resethaltreq;
wire hart3_seip;
wire core4_clk;
wire core4_dcu_clk;
wire [63:0] core4_hart_id;
wire core4_l2_clk;
wire core4_l2_reset_n;
wire core4_lm_clk;
wire core4_reset_n;
wire core4_slv1_clk;
wire core4_slv1_clk_en;
wire core4_slv_clk;
wire core4_slv_clk_en;
wire core4_slvp_reset_n;
wire hart4_ueip;
wire vpu4_clk;
wire vpu4_hvm_clk;
wire vpu4_vace_clk;
...
wire vpu4_vmac_clk;
wire vpu4_vmask_clk;
wire vpu4_vpermut_clk;
wire vpu4_vsp_clk;
wire hart4_meiack;
wire hart4_seiack;
wire hart4_stoptime;
wire vpu4_clk_en;
wire vpu4_vace_clk_en;
wire vpu4_valu_clk_en;
wire vpu4_vdiv_clk_en;
wire vpu4_vfdiv_clk_en;
wire vpu4_vfmis_clk_en;
wire vpu4_vlsu_clk_en;
wire vpu4_vmac_clk_en;
wire vpu4_vmask_clk_en;
wire vpu4_vpermut_clk_en;
wire vpu4_vsp_clk_en;
wire hart4_debugint;
wire hart4_meip;
wire hart4_msip;
wire hart4_mtip;
wire hart4_resethaltreq;
wire hart4_seip;
wire core5_clk;
wire core5_dcu_clk;
wire [63:0] core5_hart_id;
wire core5_l2_clk;
wire core5_l2_reset_n;
wire core5_lm_clk;
wire core5_reset_n;
wire core5_slv1_clk;
wire core5_slv1_clk_en;
wire core5_slv_clk;
wire core5_slv_clk_en;
wire core5_slvp_reset_n;
wire hart5_ueip;
wire vpu5_clk;
wire vpu5_hvm_clk;
wire vpu5_vace_clk;
...
wire vpu5_vmac_clk;
wire vpu5_vmask_clk;
wire vpu5_vpermut_clk;
wire vpu5_vsp_clk;
wire hart5_meiack;
wire hart5_seiack;
wire hart5_stoptime;
wire vpu5_clk_en;
wire vpu5_vace_clk_en;
wire vpu5_valu_clk_en;
wire vpu5_vdiv_clk_en;
wire vpu5_vfdiv_clk_en;
wire vpu5_vfmis_clk_en;
wire vpu5_vlsu_clk_en;
wire vpu5_vmac_clk_en;
wire vpu5_vmask_clk_en;
wire vpu5_vpermut_clk_en;
wire vpu5_vsp_clk_en;
wire hart5_debugint;
wire hart5_meip;
wire hart5_msip;
wire hart5_mtip;
wire hart5_resethaltreq;
wire hart5_seip;
wire core6_clk;
wire core6_dcu_clk;
wire [63:0] core6_hart_id;
wire core6_l2_clk;
wire core6_l2_reset_n;
wire core6_lm_clk;
wire core6_reset_n;
wire core6_slv1_clk;
wire core6_slv1_clk_en;
wire core6_slv_clk;
wire core6_slv_clk_en;
wire core6_slvp_reset_n;
wire hart6_ueip;
wire vpu6_clk;
wire vpu6_hvm_clk;
wire vpu6_vace_clk;
...
wire vpu6_vmac_clk;
wire vpu6_vmask_clk;
wire vpu6_vpermut_clk;
wire vpu6_vsp_clk;
wire hart6_meiack;
wire hart6_seiack;
wire hart6_stoptime;
wire vpu6_clk_en;
wire vpu6_vace_clk_en;
wire vpu6_valu_clk_en;
wire vpu6_vdiv_clk_en;
wire vpu6_vfdiv_clk_en;
wire vpu6_vfmis_clk_en;
wire vpu6_vlsu_clk_en;
wire vpu6_vmac_clk_en;
wire vpu6_vmask_clk_en;
wire vpu6_vpermut_clk_en;
wire vpu6_vsp_clk_en;
wire hart6_debugint;
wire hart6_meip;
wire hart6_msip;
wire hart6_mtip;
wire hart6_resethaltreq;
wire hart6_seip;
wire core7_clk;
wire core7_dcu_clk;
wire [63:0] core7_hart_id;
wire core7_l2_clk;
wire core7_l2_reset_n;
wire core7_lm_clk;
wire core7_reset_n;
wire core7_slv1_clk;
wire core7_slv1_clk_en;
wire core7_slv_clk;
wire core7_slv_clk_en;
wire core7_slvp_reset_n;
wire hart7_ueip;
wire vpu7_clk;
wire vpu7_hvm_clk;
wire vpu7_vace_clk;
...
wire vpu7_vmac_clk;
wire vpu7_vmask_clk;
wire vpu7_vpermut_clk;
wire vpu7_vsp_clk;
wire hart7_meiack;
wire hart7_seiack;
wire hart7_stoptime;
wire vpu7_clk_en;
wire vpu7_vace_clk_en;
wire vpu7_valu_clk_en;
wire vpu7_vdiv_clk_en;
wire vpu7_vfdiv_clk_en;
wire vpu7_vfmis_clk_en;
wire vpu7_vlsu_clk_en;
wire vpu7_vmac_clk_en;
wire vpu7_vmask_clk_en;
wire vpu7_vpermut_clk_en;
wire vpu7_vsp_clk_en;
wire hart7_debugint;
wire hart7_meip;
wire hart7_msip;
wire hart7_mtip;
wire hart7_resethaltreq;
wire hart7_seip;
...
wire l2c_bank2_data_ram_clk;
wire l2c_bank2_data_ram_clk_en;
wire l2c_bank3_data_ram_clk;
wire l2c_bank3_data_ram_clk_en;
...
wire core2_hart_halted;
wire core2_hart_unavail;
wire core2_hart_under_reset;
wire core3_hart_halted;
wire core3_hart_unavail;
wire core3_hart_under_reset;
wire core4_hart_halted;
wire core4_hart_unavail;
wire core4_hart_under_reset;
wire core5_hart_halted;
wire core5_hart_unavail;
wire core5_hart_under_reset;
wire core6_hart_halted;
wire core6_hart_unavail;
wire core6_hart_under_reset;
wire core7_hart_halted;
wire core7_hart_unavail;
wire core7_hart_under_reset;
...
assign hart2_wakeup_event = {plic_hart2_meip,plic_hart2_seip,1'b0,mtip[2],plicsw_hart2_msip,dm_debugint[2]};
assign hart2_ueip = 1'b0;
assign core2_clk = core_clk[2];
assign vpu2_clk = vpu_clk[2];
assign vpu2_vlsu_clk = vpu_vlsu_clk[2];
assign vpu2_valu_clk = vpu_valu_clk[2];
assign vpu2_vfmis_clk = vpu_vfmis_clk[2];
assign vpu2_vmac_clk = vpu_vmac_clk[2];
assign vpu2_vfdiv_clk = vpu_vfdiv_clk[2];
assign vpu2_vdiv_clk = vpu_vdiv_clk[2];
assign vpu2_vmask_clk = vpu_vmask_clk[2];
assign vpu2_vpermut_clk = vpu_vpermut_clk[2];
assign vpu2_vace_clk = vpu_vace_clk[2];
assign vpu2_vsp_clk = vpu_vsp_clk[2];
assign vpu2_hvm_clk = hvm_clk;
assign vpu_clk_en[2] = vpu2_clk_en;
assign vpu_vlsu_clk_en[2] = vpu2_vlsu_clk_en;
assign vpu_valu_clk_en[2] = vpu2_valu_clk_en;
assign vpu_vfmis_clk_en[2] = vpu2_vfmis_clk_en;
assign vpu_vmac_clk_en[2] = vpu2_vmac_clk_en;
assign vpu_vfdiv_clk_en[2] = vpu2_vfdiv_clk_en;
assign vpu_vdiv_clk_en[2] = vpu2_vdiv_clk_en;
assign vpu_vmask_clk_en[2] = vpu2_vmask_clk_en;
assign vpu_vpermut_clk_en[2] = vpu2_vpermut_clk_en;
assign vpu_vace_clk_en[2] = vpu2_vace_clk_en;
assign vpu_vsp_clk_en[2] = vpu2_vsp_clk_en;
assign core2_dcu_clk = dc_clk[2];
assign core2_reset_n = core_resetn[2];
assign core2_l2_reset_n = core_l2_resetn[2];
assign core2_l2_clk = l2_clk;
assign core2_slvp_reset_n = slvp_resetn[2];
assign core2_lm_clk = lm_clk[2];
assign core2_slv_clk = aclk;
assign core2_slv_clk_en = axi_bus_clk_en;
assign core2_slv1_clk = aclk;
assign core2_slv1_clk_en = axi_bus_clk_en;
assign core2_hart_id = 64'd2;
assign hart3_wakeup_event = {plic_hart3_meip,plic_hart3_seip,1'b0,mtip[3],plicsw_hart3_msip,dm_debugint[3]};
assign hart3_ueip = 1'b0;
assign core3_clk = core_clk[3];
assign vpu3_clk = vpu_clk[3];
assign vpu3_vlsu_clk = vpu_vlsu_clk[3];
assign vpu3_valu_clk = vpu_valu_clk[3];
assign vpu3_vfmis_clk = vpu_vfmis_clk[3];
assign vpu3_vmac_clk = vpu_vmac_clk[3];
assign vpu3_vfdiv_clk = vpu_vfdiv_clk[3];
assign vpu3_vdiv_clk = vpu_vdiv_clk[3];
assign vpu3_vmask_clk = vpu_vmask_clk[3];
assign vpu3_vpermut_clk = vpu_vpermut_clk[3];
assign vpu3_vace_clk = vpu_vace_clk[3];
assign vpu3_vsp_clk = vpu_vsp_clk[3];
assign vpu3_hvm_clk = hvm_clk;
assign vpu_clk_en[3] = vpu3_clk_en;
assign vpu_vlsu_clk_en[3] = vpu3_vlsu_clk_en;
assign vpu_valu_clk_en[3] = vpu3_valu_clk_en;
assign vpu_vfmis_clk_en[3] = vpu3_vfmis_clk_en;
assign vpu_vmac_clk_en[3] = vpu3_vmac_clk_en;
assign vpu_vfdiv_clk_en[3] = vpu3_vfdiv_clk_en;
assign vpu_vdiv_clk_en[3] = vpu3_vdiv_clk_en;
assign vpu_vmask_clk_en[3] = vpu3_vmask_clk_en;
assign vpu_vpermut_clk_en[3] = vpu3_vpermut_clk_en;
assign vpu_vace_clk_en[3] = vpu3_vace_clk_en;
assign vpu_vsp_clk_en[3] = vpu3_vsp_clk_en;
assign core3_dcu_clk = dc_clk[3];
assign core3_reset_n = core_resetn[3];
assign core3_l2_reset_n = core_l2_resetn[3];
assign core3_l2_clk = l2_clk;
assign core3_slvp_reset_n = slvp_resetn[3];
assign core3_lm_clk = lm_clk[3];
assign core3_slv_clk = aclk;
assign core3_slv_clk_en = axi_bus_clk_en;
assign core3_slv1_clk = aclk;
assign core3_slv1_clk_en = axi_bus_clk_en;
assign core3_hart_id = 64'd3;
assign hart4_wakeup_event = {plic_hart4_meip,plic_hart4_seip,1'b0,mtip[4],plicsw_hart4_msip,dm_debugint[4]};
assign hart4_ueip = 1'b0;
assign core4_clk = core_clk[4];
assign vpu4_clk = vpu_clk[4];
assign vpu4_vlsu_clk = vpu_vlsu_clk[4];
assign vpu4_valu_clk = vpu_valu_clk[4];
assign vpu4_vfmis_clk = vpu_vfmis_clk[4];
assign vpu4_vmac_clk = vpu_vmac_clk[4];
assign vpu4_vfdiv_clk = vpu_vfdiv_clk[4];
assign vpu4_vdiv_clk = vpu_vdiv_clk[4];
assign vpu4_vmask_clk = vpu_vmask_clk[4];
assign vpu4_vpermut_clk = vpu_vpermut_clk[4];
assign vpu4_vace_clk = vpu_vace_clk[4];
assign vpu4_vsp_clk = vpu_vsp_clk[4];
assign vpu4_hvm_clk = hvm_clk;
assign vpu_clk_en[4] = vpu4_clk_en;
assign vpu_vlsu_clk_en[4] = vpu4_vlsu_clk_en;
assign vpu_valu_clk_en[4] = vpu4_valu_clk_en;
assign vpu_vfmis_clk_en[4] = vpu4_vfmis_clk_en;
assign vpu_vmac_clk_en[4] = vpu4_vmac_clk_en;
assign vpu_vfdiv_clk_en[4] = vpu4_vfdiv_clk_en;
assign vpu_vdiv_clk_en[4] = vpu4_vdiv_clk_en;
assign vpu_vmask_clk_en[4] = vpu4_vmask_clk_en;
assign vpu_vpermut_clk_en[4] = vpu4_vpermut_clk_en;
assign vpu_vace_clk_en[4] = vpu4_vace_clk_en;
assign vpu_vsp_clk_en[4] = vpu4_vsp_clk_en;
assign core4_dcu_clk = dc_clk[4];
assign core4_reset_n = core_resetn[4];
assign core4_l2_reset_n = core_l2_resetn[4];
assign core4_l2_clk = l2_clk;
assign core4_slvp_reset_n = slvp_resetn[4];
assign core4_lm_clk = lm_clk[4];
assign core4_slv_clk = aclk;
assign core4_slv_clk_en = axi_bus_clk_en;
assign core4_slv1_clk = aclk;
assign core4_slv1_clk_en = axi_bus_clk_en;
assign core4_hart_id = 64'd4;
assign hart5_wakeup_event = {plic_hart5_meip,plic_hart5_seip,1'b0,mtip[5],plicsw_hart5_msip,dm_debugint[5]};
assign hart5_ueip = 1'b0;
assign core5_clk = core_clk[5];
assign vpu5_clk = vpu_clk[5];
assign vpu5_vlsu_clk = vpu_vlsu_clk[5];
assign vpu5_valu_clk = vpu_valu_clk[5];
assign vpu5_vfmis_clk = vpu_vfmis_clk[5];
assign vpu5_vmac_clk = vpu_vmac_clk[5];
assign vpu5_vfdiv_clk = vpu_vfdiv_clk[5];
assign vpu5_vdiv_clk = vpu_vdiv_clk[5];
assign vpu5_vmask_clk = vpu_vmask_clk[5];
assign vpu5_vpermut_clk = vpu_vpermut_clk[5];
assign vpu5_vace_clk = vpu_vace_clk[5];
assign vpu5_vsp_clk = vpu_vsp_clk[5];
assign vpu5_hvm_clk = hvm_clk;
assign vpu_clk_en[5] = vpu5_clk_en;
assign vpu_vlsu_clk_en[5] = vpu5_vlsu_clk_en;
assign vpu_valu_clk_en[5] = vpu5_valu_clk_en;
assign vpu_vfmis_clk_en[5] = vpu5_vfmis_clk_en;
assign vpu_vmac_clk_en[5] = vpu5_vmac_clk_en;
assign vpu_vfdiv_clk_en[5] = vpu5_vfdiv_clk_en;
assign vpu_vdiv_clk_en[5] = vpu5_vdiv_clk_en;
assign vpu_vmask_clk_en[5] = vpu5_vmask_clk_en;
assign vpu_vpermut_clk_en[5] = vpu5_vpermut_clk_en;
assign vpu_vace_clk_en[5] = vpu5_vace_clk_en;
assign vpu_vsp_clk_en[5] = vpu5_vsp_clk_en;
assign core5_dcu_clk = dc_clk[5];
assign core5_reset_n = core_resetn[5];
assign core5_l2_reset_n = core_l2_resetn[5];
assign core5_l2_clk = l2_clk;
assign core5_slvp_reset_n = slvp_resetn[5];
assign core5_lm_clk = lm_clk[5];
assign core5_slv_clk = aclk;
assign core5_slv_clk_en = axi_bus_clk_en;
assign core5_slv1_clk = aclk;
assign core5_slv1_clk_en = axi_bus_clk_en;
assign core5_hart_id = 64'd5;
assign hart6_wakeup_event = {plic_hart6_meip,plic_hart6_seip,1'b0,mtip[6],plicsw_hart6_msip,dm_debugint[6]};
assign hart6_ueip = 1'b0;
assign core6_clk = core_clk[6];
assign vpu6_clk = vpu_clk[6];
assign vpu6_vlsu_clk = vpu_vlsu_clk[6];
assign vpu6_valu_clk = vpu_valu_clk[6];
assign vpu6_vfmis_clk = vpu_vfmis_clk[6];
assign vpu6_vmac_clk = vpu_vmac_clk[6];
assign vpu6_vfdiv_clk = vpu_vfdiv_clk[6];
assign vpu6_vdiv_clk = vpu_vdiv_clk[6];
assign vpu6_vmask_clk = vpu_vmask_clk[6];
assign vpu6_vpermut_clk = vpu_vpermut_clk[6];
assign vpu6_vace_clk = vpu_vace_clk[6];
assign vpu6_vsp_clk = vpu_vsp_clk[6];
assign vpu6_hvm_clk = hvm_clk;
assign vpu_clk_en[6] = vpu6_clk_en;
assign vpu_vlsu_clk_en[6] = vpu6_vlsu_clk_en;
assign vpu_valu_clk_en[6] = vpu6_valu_clk_en;
assign vpu_vfmis_clk_en[6] = vpu6_vfmis_clk_en;
assign vpu_vmac_clk_en[6] = vpu6_vmac_clk_en;
assign vpu_vfdiv_clk_en[6] = vpu6_vfdiv_clk_en;
assign vpu_vdiv_clk_en[6] = vpu6_vdiv_clk_en;
assign vpu_vmask_clk_en[6] = vpu6_vmask_clk_en;
assign vpu_vpermut_clk_en[6] = vpu6_vpermut_clk_en;
assign vpu_vace_clk_en[6] = vpu6_vace_clk_en;
assign vpu_vsp_clk_en[6] = vpu6_vsp_clk_en;
assign core6_dcu_clk = dc_clk[6];
assign core6_reset_n = core_resetn[6];
assign core6_l2_reset_n = core_l2_resetn[6];
assign core6_l2_clk = l2_clk;
assign core6_slvp_reset_n = slvp_resetn[6];
assign core6_lm_clk = lm_clk[6];
assign core6_slv_clk = aclk;
assign core6_slv_clk_en = axi_bus_clk_en;
assign core6_slv1_clk = aclk;
assign core6_slv1_clk_en = axi_bus_clk_en;
assign core6_hart_id = 64'd6;
assign hart7_wakeup_event = {plic_hart7_meip,plic_hart7_seip,1'b0,mtip[7],plicsw_hart7_msip,dm_debugint[7]};
assign hart7_ueip = 1'b0;
assign core7_clk = core_clk[7];
assign vpu7_clk = vpu_clk[7];
assign vpu7_vlsu_clk = vpu_vlsu_clk[7];
assign vpu7_valu_clk = vpu_valu_clk[7];
assign vpu7_vfmis_clk = vpu_vfmis_clk[7];
assign vpu7_vmac_clk = vpu_vmac_clk[7];
assign vpu7_vfdiv_clk = vpu_vfdiv_clk[7];
assign vpu7_vdiv_clk = vpu_vdiv_clk[7];
assign vpu7_vmask_clk = vpu_vmask_clk[7];
assign vpu7_vpermut_clk = vpu_vpermut_clk[7];
assign vpu7_vace_clk = vpu_vace_clk[7];
assign vpu7_vsp_clk = vpu_vsp_clk[7];
assign vpu7_hvm_clk = hvm_clk;
assign vpu_clk_en[7] = vpu7_clk_en;
assign vpu_vlsu_clk_en[7] = vpu7_vlsu_clk_en;
assign vpu_valu_clk_en[7] = vpu7_valu_clk_en;
assign vpu_vfmis_clk_en[7] = vpu7_vfmis_clk_en;
assign vpu_vmac_clk_en[7] = vpu7_vmac_clk_en;
assign vpu_vfdiv_clk_en[7] = vpu7_vfdiv_clk_en;
assign vpu_vdiv_clk_en[7] = vpu7_vdiv_clk_en;
assign vpu_vmask_clk_en[7] = vpu7_vmask_clk_en;
assign vpu_vpermut_clk_en[7] = vpu7_vpermut_clk_en;
assign vpu_vace_clk_en[7] = vpu7_vace_clk_en;
assign vpu_vsp_clk_en[7] = vpu7_vsp_clk_en;
assign core7_dcu_clk = dc_clk[7];
assign core7_reset_n = core_resetn[7];
assign core7_l2_reset_n = core_l2_resetn[7];
assign core7_l2_clk = l2_clk;
assign core7_slvp_reset_n = slvp_resetn[7];
assign core7_lm_clk = lm_clk[7];
assign core7_slv_clk = aclk;
assign core7_slv_clk_en = axi_bus_clk_en;
assign core7_slv1_clk = aclk;
assign core7_slv1_clk_en = axi_bus_clk_en;
assign core7_hart_id = 64'd7;
...
assign dm_hart_unavail[2] = core2_hart_unavail;
assign dm_hart_under_reset[2] = core2_hart_under_reset;
assign dm_hart_unavail[3] = core3_hart_unavail;
assign dm_hart_under_reset[3] = core3_hart_under_reset;
assign dm_hart_unavail[4] = core4_hart_unavail;
assign dm_hart_under_reset[4] = core4_hart_under_reset;
assign dm_hart_unavail[5] = core5_hart_unavail;
assign dm_hart_under_reset[5] = core5_hart_under_reset;
assign dm_hart_unavail[6] = core6_hart_unavail;
assign dm_hart_under_reset[6] = core6_hart_under_reset;
assign dm_hart_unavail[7] = core7_hart_unavail;
assign dm_hart_under_reset[7] = core7_hart_under_reset;
generate
...
endgenerate
generate
    if (COMPLEX_BRG_TYPE != 2 && BIU_ASYNC_SUPPORT != 1) begin:gen_core2_no_sync
        assign hart2_debugint = dm_debugint[2];
        assign hart2_resethaltreq = dm_resethaltreq[2];
        assign hart2_seip = plic_hart2_seip;
        assign plic_hart2_seiack = hart2_seiack;
        assign hart2_meip = plic_hart2_meip;
        assign plic_hart2_meiack = hart2_meiack;
        assign hart2_msip = plicsw_hart2_msip;
        assign hart2_mtip = mtip[2];
        assign plmt_hart2_stoptime = hart2_stoptime;
    end
endgenerate
generate
    if (COMPLEX_BRG_TYPE != 2 && BIU_ASYNC_SUPPORT != 1) begin:gen_core3_no_sync
        assign hart3_debugint = dm_debugint[3];
        assign hart3_resethaltreq = dm_resethaltreq[3];
        assign hart3_seip = plic_hart3_seip;
        assign plic_hart3_seiack = hart3_seiack;
        assign hart3_meip = plic_hart3_meip;
        assign plic_hart3_meiack = hart3_meiack;
        assign hart3_msip = plicsw_hart3_msip;
        assign hart3_mtip = mtip[3];
        assign plmt_hart3_stoptime = hart3_stoptime;
    end
endgenerate
generate
    if (COMPLEX_BRG_TYPE != 2 && BIU_ASYNC_SUPPORT != 1) begin:gen_core4_no_sync
        assign hart4_debugint = dm_debugint[4];
        assign hart4_resethaltreq = dm_resethaltreq[4];
        assign hart4_seip = plic_hart4_seip;
        assign plic_hart4_seiack = hart4_seiack;
        assign hart4_meip = plic_hart4_meip;
        assign plic_hart4_meiack = hart4_meiack;
        assign hart4_msip = plicsw_hart4_msip;
        assign hart4_mtip = mtip[4];
        assign plmt_hart4_stoptime = hart4_stoptime;
    end
endgenerate
generate
    if (COMPLEX_BRG_TYPE != 2 && BIU_ASYNC_SUPPORT != 1) begin:gen_core5_no_sync
        assign hart5_debugint = dm_debugint[5];
        assign hart5_resethaltreq = dm_resethaltreq[5];
        assign hart5_seip = plic_hart5_seip;
        assign plic_hart5_seiack = hart5_seiack;
        assign hart5_meip = plic_hart5_meip;
        assign plic_hart5_meiack = hart5_meiack;
        assign hart5_msip = plicsw_hart5_msip;
        assign hart5_mtip = mtip[5];
        assign plmt_hart5_stoptime = hart5_stoptime;
    end
endgenerate
generate
    if (COMPLEX_BRG_TYPE != 2 && BIU_ASYNC_SUPPORT != 1) begin:gen_core6_no_sync
        assign hart6_debugint = dm_debugint[6];
        assign hart6_resethaltreq = dm_resethaltreq[6];
        assign hart6_seip = plic_hart6_seip;
        assign plic_hart6_seiack = hart6_seiack;
        assign hart6_meip = plic_hart6_meip;
        assign plic_hart6_meiack = hart6_meiack;
        assign hart6_msip = plicsw_hart6_msip;
        assign hart6_mtip = mtip[6];
        assign plmt_hart6_stoptime = hart6_stoptime;
    end
endgenerate
generate
    if (COMPLEX_BRG_TYPE != 2 && BIU_ASYNC_SUPPORT != 1) begin:gen_core7_no_sync
        assign hart7_debugint = dm_debugint[7];
        assign hart7_resethaltreq = dm_resethaltreq[7];
        assign hart7_seip = plic_hart7_seip;
        assign plic_hart7_seiack = hart7_seiack;
        assign hart7_meip = plic_hart7_meip;
        assign plic_hart7_meiack = hart7_meiack;
        assign hart7_msip = plicsw_hart7_msip;
        assign hart7_mtip = mtip[7];
        assign plmt_hart7_stoptime = hart7_stoptime;
    end
endgenerate
generate
...
assign nds_unused_hart2_wire = 1'b0 | (|core2_hart_id[63:0]) | core2_lm_clk | core2_slv_clk_en | core2_slv_clk | core2_slv1_clk_en | core2_slv1_clk | core2_slvp_reset_n | core2_l2_clk | core2_l2_reset_n | core2_hart_halted | hart2_ueip | vpu2_hvm_clk;
assign nds_unused_hart3_wire = 1'b0 | (|core3_hart_id[63:0]) | core3_lm_clk | core3_slv_clk_en | core3_slv_clk | core3_slv1_clk_en | core3_slv1_clk | core3_slvp_reset_n | core3_l2_clk | core3_l2_reset_n | core3_hart_halted | hart3_ueip | vpu3_hvm_clk;
assign nds_unused_hart4_wire = 1'b0 | (|core4_hart_id[63:0]) | core4_lm_clk | core4_slv_clk_en | core4_slv_clk | core4_slv1_clk_en | core4_slv1_clk | core4_slvp_reset_n | core4_l2_clk | core4_l2_reset_n | core4_hart_halted | hart4_ueip | vpu4_hvm_clk;
assign nds_unused_hart5_wire = 1'b0 | (|core5_hart_id[63:0]) | core5_lm_clk | core5_slv_clk_en | core5_slv_clk | core5_slv1_clk_en | core5_slv1_clk | core5_slvp_reset_n | core5_l2_clk | core5_l2_reset_n | core5_hart_halted | hart5_ueip | vpu5_hvm_clk;
assign nds_unused_hart6_wire = 1'b0 | (|core6_hart_id[63:0]) | core6_lm_clk | core6_slv_clk_en | core6_slv_clk | core6_slv1_clk_en | core6_slv1_clk | core6_slvp_reset_n | core6_l2_clk | core6_l2_reset_n | core6_hart_halted | hart6_ueip | vpu6_hvm_clk;
assign nds_unused_hart7_wire = 1'b0 | (|core7_hart_id[63:0]) | core7_lm_clk | core7_slv_clk_en | core7_slv_clk | core7_slv1_clk_en | core7_slv1_clk | core7_slvp_reset_n | core7_l2_clk | core7_l2_reset_n | core7_hart_halted | hart7_ueip | vpu7_hvm_clk;
...
ax45mpv_cluster u_cluster(
    ...
    .core2_clk(core2_clk),
    .core2_dcache_disable_init(hart2_dcache_disable_init),
    .core2_dcu_clk(core2_dcu_clk),
    .core2_hart_id(64'd2),
    .core2_meiack(hart2_meiack),
    .core2_meiid(hart2_meiid),
    .core2_meip(hart2_meip),
    .core2_msip(hart2_msip),
    .core2_mtip(hart2_mtip),
    .core2_nmi(hart2_nmi),
    .core2_reset_n(core2_reset_n),
    .core2_reset_vector(hart2_reset_vector),
    .core2_wfi_mode(hart2_core_wfi_mode),
    .vpu2_clk(vpu2_clk),
    .vpu2_vace_clk(vpu2_vace_clk),
    .vpu2_valu_clk(vpu2_valu_clk),
    .vpu2_vdiv_clk(vpu2_vdiv_clk),
    .vpu2_vfdiv_clk(vpu2_vfdiv_clk),
    .vpu2_vfmis_clk(vpu2_vfmis_clk),
    .vpu2_vlsu_clk(vpu2_vlsu_clk),
    .vpu2_vmac_clk(vpu2_vmac_clk),
    .vpu2_vmask_clk(vpu2_vmask_clk),
    .vpu2_vpermut_clk(vpu2_vpermut_clk),
    .vpu2_vsp_clk(vpu2_vsp_clk),
    .core3_clk(core3_clk),
    .core3_dcache_disable_init(hart3_dcache_disable_init),
    .core3_dcu_clk(core3_dcu_clk),
    .core3_hart_id(64'd3),
    .core3_meiack(hart3_meiack),
    .core3_meiid(hart3_meiid),
    .core3_meip(hart3_meip),
    .core3_msip(hart3_msip),
    .core3_mtip(hart3_mtip),
    .core3_nmi(hart3_nmi),
    .core3_reset_n(core3_reset_n),
    .core3_reset_vector(hart3_reset_vector),
    .core3_wfi_mode(hart3_core_wfi_mode),
    .vpu3_clk(vpu3_clk),
    .vpu3_vace_clk(vpu3_vace_clk),
    .vpu3_valu_clk(vpu3_valu_clk),
    .vpu3_vdiv_clk(vpu3_vdiv_clk),
    .vpu3_vfdiv_clk(vpu3_vfdiv_clk),
    .vpu3_vfmis_clk(vpu3_vfmis_clk),
    .vpu3_vlsu_clk(vpu3_vlsu_clk),
    .vpu3_vmac_clk(vpu3_vmac_clk),
    .vpu3_vmask_clk(vpu3_vmask_clk),
    .vpu3_vpermut_clk(vpu3_vpermut_clk),
    .vpu3_vsp_clk(vpu3_vsp_clk),
    .core4_clk(core4_clk),
    .core4_dcache_disable_init(hart4_dcache_disable_init),
    .core4_dcu_clk(core4_dcu_clk),
    .core4_hart_id(64'd4),
    .core4_meiack(hart4_meiack),
    .core4_meiid(hart4_meiid),
    .core4_meip(hart4_meip),
    .core4_msip(hart4_msip),
    .core4_mtip(hart4_mtip),
    .core4_nmi(hart4_nmi),
    .core4_reset_n(core4_reset_n),
    .core4_reset_vector(hart4_reset_vector),
    .core4_wfi_mode(hart4_core_wfi_mode),
    .vpu4_clk(vpu4_clk),
    .vpu4_vace_clk(vpu4_vace_clk),
    .vpu4_valu_clk(vpu4_valu_clk),
    .vpu4_vdiv_clk(vpu4_vdiv_clk),
    .vpu4_vfdiv_clk(vpu4_vfdiv_clk),
    .vpu4_vfmis_clk(vpu4_vfmis_clk),
    .vpu4_vlsu_clk(vpu4_vlsu_clk),
    .vpu4_vmac_clk(vpu4_vmac_clk),
    .vpu4_vmask_clk(vpu4_vmask_clk),
    .vpu4_vpermut_clk(vpu4_vpermut_clk),
    .vpu4_vsp_clk(vpu4_vsp_clk),
    .core5_clk(core5_clk),
    .core5_dcache_disable_init(hart5_dcache_disable_init),
    .core5_dcu_clk(core5_dcu_clk),
    .core5_hart_id(64'd5),
    .core5_meiack(hart5_meiack),
    .core5_meiid(hart5_meiid),
    .core5_meip(hart5_meip),
    .core5_msip(hart5_msip),
    .core5_mtip(hart5_mtip),
    .core5_nmi(hart5_nmi),
    .core5_reset_n(core5_reset_n),
    .core5_reset_vector(hart5_reset_vector),
    .core5_wfi_mode(hart5_core_wfi_mode),
    .vpu5_clk(vpu5_clk),
    .vpu5_vace_clk(vpu5_vace_clk),
    .vpu5_valu_clk(vpu5_valu_clk),
    .vpu5_vdiv_clk(vpu5_vdiv_clk),
    .vpu5_vfdiv_clk(vpu5_vfdiv_clk),
    .vpu5_vfmis_clk(vpu5_vfmis_clk),
    .vpu5_vlsu_clk(vpu5_vlsu_clk),
    .vpu5_vmac_clk(vpu5_vmac_clk),
    .vpu5_vmask_clk(vpu5_vmask_clk),
    .vpu5_vpermut_clk(vpu5_vpermut_clk),
    .vpu5_vsp_clk(vpu5_vsp_clk),
    .core6_clk(core6_clk),
    .core6_dcache_disable_init(hart6_dcache_disable_init),
    .core6_dcu_clk(core6_dcu_clk),
    .core6_hart_id(64'd6),
    .core6_meiack(hart6_meiack),
    .core6_meiid(hart6_meiid),
    .core6_meip(hart6_meip),
    .core6_msip(hart6_msip),
    .core6_mtip(hart6_mtip),
    .core6_nmi(hart6_nmi),
    .core6_reset_n(core6_reset_n),
    .core6_reset_vector(hart6_reset_vector),
    .core6_wfi_mode(hart6_core_wfi_mode),
    .vpu6_clk(vpu6_clk),
    .vpu6_vace_clk(vpu6_vace_clk),
    .vpu6_valu_clk(vpu6_valu_clk),
    .vpu6_vdiv_clk(vpu6_vdiv_clk),
    .vpu6_vfdiv_clk(vpu6_vfdiv_clk),
    .vpu6_vfmis_clk(vpu6_vfmis_clk),
    .vpu6_vlsu_clk(vpu6_vlsu_clk),
    .vpu6_vmac_clk(vpu6_vmac_clk),
    .vpu6_vmask_clk(vpu6_vmask_clk),
    .vpu6_vpermut_clk(vpu6_vpermut_clk),
    .vpu6_vsp_clk(vpu6_vsp_clk),
    .core7_clk(core7_clk),
    .core7_dcache_disable_init(hart7_dcache_disable_init),
    .core7_dcu_clk(core7_dcu_clk),
    .core7_hart_id(64'd7),
    .core7_meiack(hart7_meiack),
    .core7_meiid(hart7_meiid),
    .core7_meip(hart7_meip),
    .core7_msip(hart7_msip),
    .core7_mtip(hart7_mtip),
    .core7_nmi(hart7_nmi),
    .core7_reset_n(core7_reset_n),
    .core7_reset_vector(hart7_reset_vector),
    .core7_wfi_mode(hart7_core_wfi_mode),
    .vpu7_clk(vpu7_clk),
    .vpu7_vace_clk(vpu7_vace_clk),
    .vpu7_valu_clk(vpu7_valu_clk),
    .vpu7_vdiv_clk(vpu7_vdiv_clk),
    .vpu7_vfdiv_clk(vpu7_vfdiv_clk),
    .vpu7_vfmis_clk(vpu7_vfmis_clk),
    .vpu7_vlsu_clk(vpu7_vlsu_clk),
    .vpu7_vmac_clk(vpu7_vmac_clk),
    .vpu7_vmask_clk(vpu7_vmask_clk),
    .vpu7_vpermut_clk(vpu7_vpermut_clk),
    .vpu7_vsp_clk(vpu7_vsp_clk),
    ...
    .l2c_bank2_data_ram_clk(l2c_bank2_data_ram_clk),
    .l2c_bank2_data_ram_clk_en(l2c_bank2_data_ram_clk_en),
    .l2c_bank3_data_ram_clk(l2c_bank3_data_ram_clk),
    .l2c_bank3_data_ram_clk_en(l2c_bank3_data_ram_clk_en),
    ...
    .core2_debugint(hart2_debugint),
    .core2_hart_halted(core2_hart_halted),
    .core2_hart_unavail(core2_hart_unavail),
    .core2_hart_under_reset(core2_hart_under_reset),
    .core2_resethaltreq(hart2_resethaltreq),
    .core2_stoptime(hart2_stoptime),
    .core3_debugint(hart3_debugint),
    .core3_hart_halted(core3_hart_halted),
    .core3_hart_unavail(core3_hart_unavail),
    .core3_hart_under_reset(core3_hart_under_reset),
    .core3_resethaltreq(hart3_resethaltreq),
    .core3_stoptime(hart3_stoptime),
    .core4_debugint(hart4_debugint),
    .core4_hart_halted(core4_hart_halted),
    .core4_hart_unavail(core4_hart_unavail),
    .core4_hart_under_reset(core4_hart_under_reset),
    .core4_resethaltreq(hart4_resethaltreq),
    .core4_stoptime(hart4_stoptime),
    .core5_debugint(hart5_debugint),
    .core5_hart_halted(core5_hart_halted),
    .core5_hart_unavail(core5_hart_unavail),
    .core5_hart_under_reset(core5_hart_under_reset),
    .core5_resethaltreq(hart5_resethaltreq),
    .core5_stoptime(hart5_stoptime),
    .core6_debugint(hart6_debugint),
    .core6_hart_halted(core6_hart_halted),
    .core6_hart_unavail(core6_hart_unavail),
    .core6_hart_under_reset(core6_hart_under_reset),
    .core6_resethaltreq(hart6_resethaltreq),
    .core6_stoptime(hart6_stoptime),
    .core7_debugint(hart7_debugint),
    .core7_hart_halted(core7_hart_halted),
    .core7_hart_unavail(core7_hart_unavail),
    .core7_hart_under_reset(core7_hart_under_reset),
    .core7_resethaltreq(hart7_resethaltreq),
    .core7_stoptime(hart7_stoptime),
    ...
    .core2_icache_disable_init(hart2_icache_disable_init),
    .core2_seiack(hart2_seiack),
    .core2_seiid(hart2_seiid),
    .core2_seip(hart2_seip),
    .vpu2_clk_en(vpu2_clk_en),
    .vpu2_vace_clk_en(vpu2_vace_clk_en),
    .vpu2_valu_clk_en(vpu2_valu_clk_en),
    .vpu2_vdiv_clk_en(vpu2_vdiv_clk_en),
    .vpu2_vfdiv_clk_en(vpu2_vfdiv_clk_en),
    .vpu2_vfmis_clk_en(vpu2_vfmis_clk_en),
    .vpu2_vlsu_clk_en(vpu2_vlsu_clk_en),
    .vpu2_vmac_clk_en(vpu2_vmac_clk_en),
    .vpu2_vmask_clk_en(vpu2_vmask_clk_en),
    .vpu2_vpermut_clk_en(vpu2_vpermut_clk_en),
    .vpu2_vsp_clk_en(vpu2_vsp_clk_en),
    .core3_icache_disable_init(hart3_icache_disable_init),
    .core3_seiack(hart3_seiack),
    .core3_seiid(hart3_seiid),
    .core3_seip(hart3_seip),
    .vpu3_clk_en(vpu3_clk_en),
    .vpu3_vace_clk_en(vpu3_vace_clk_en),
    .vpu3_valu_clk_en(vpu3_valu_clk_en),
    .vpu3_vdiv_clk_en(vpu3_vdiv_clk_en),
    .vpu3_vfdiv_clk_en(vpu3_vfdiv_clk_en),
    .vpu3_vfmis_clk_en(vpu3_vfmis_clk_en),
    .vpu3_vlsu_clk_en(vpu3_vlsu_clk_en),
    .vpu3_vmac_clk_en(vpu3_vmac_clk_en),
    .vpu3_vmask_clk_en(vpu3_vmask_clk_en),
    .vpu3_vpermut_clk_en(vpu3_vpermut_clk_en),
    .vpu3_vsp_clk_en(vpu3_vsp_clk_en),
    .core4_icache_disable_init(hart4_icache_disable_init),
    .core4_seiack(hart4_seiack),
    .core4_seiid(hart4_seiid),
    .core4_seip(hart4_seip),
    .vpu4_clk_en(vpu4_clk_en),
    .vpu4_vace_clk_en(vpu4_vace_clk_en),
    .vpu4_valu_clk_en(vpu4_valu_clk_en),
    .vpu4_vdiv_clk_en(vpu4_vdiv_clk_en),
    .vpu4_vfdiv_clk_en(vpu4_vfdiv_clk_en),
    .vpu4_vfmis_clk_en(vpu4_vfmis_clk_en),
    .vpu4_vlsu_clk_en(vpu4_vlsu_clk_en),
    .vpu4_vmac_clk_en(vpu4_vmac_clk_en),
    .vpu4_vmask_clk_en(vpu4_vmask_clk_en),
    .vpu4_vpermut_clk_en(vpu4_vpermut_clk_en),
    .vpu4_vsp_clk_en(vpu4_vsp_clk_en),
    .core5_icache_disable_init(hart5_icache_disable_init),
    .core5_seiack(hart5_seiack),
    .core5_seiid(hart5_seiid),
    .core5_seip(hart5_seip),
    .vpu5_clk_en(vpu5_clk_en),
    .vpu5_vace_clk_en(vpu5_vace_clk_en),
    .vpu5_valu_clk_en(vpu5_valu_clk_en),
    .vpu5_vdiv_clk_en(vpu5_vdiv_clk_en),
    .vpu5_vfdiv_clk_en(vpu5_vfdiv_clk_en),
    .vpu5_vfmis_clk_en(vpu5_vfmis_clk_en),
    .vpu5_vlsu_clk_en(vpu5_vlsu_clk_en),
    .vpu5_vmac_clk_en(vpu5_vmac_clk_en),
    .vpu5_vmask_clk_en(vpu5_vmask_clk_en),
    .vpu5_vpermut_clk_en(vpu5_vpermut_clk_en),
    .vpu5_vsp_clk_en(vpu5_vsp_clk_en),
    .core6_icache_disable_init(hart6_icache_disable_init),
    .core6_seiack(hart6_seiack),
    .core6_seiid(hart6_seiid),
    .core6_seip(hart6_seip),
    .vpu6_clk_en(vpu6_clk_en),
    .vpu6_vace_clk_en(vpu6_vace_clk_en),
    .vpu6_valu_clk_en(vpu6_valu_clk_en),
    .vpu6_vdiv_clk_en(vpu6_vdiv_clk_en),
    .vpu6_vfdiv_clk_en(vpu6_vfdiv_clk_en),
    .vpu6_vfmis_clk_en(vpu6_vfmis_clk_en),
    .vpu6_vlsu_clk_en(vpu6_vlsu_clk_en),
    .vpu6_vmac_clk_en(vpu6_vmac_clk_en),
    .vpu6_vmask_clk_en(vpu6_vmask_clk_en),
    .vpu6_vpermut_clk_en(vpu6_vpermut_clk_en),
    .vpu6_vsp_clk_en(vpu6_vsp_clk_en),
    .core7_icache_disable_init(hart7_icache_disable_init),
    .core7_seiack(hart7_seiack),
    .core7_seiid(hart7_seiid),
    .core7_seip(hart7_seip),
    .vpu7_clk_en(vpu7_clk_en),
    .vpu7_vace_clk_en(vpu7_vace_clk_en),
    .vpu7_valu_clk_en(vpu7_valu_clk_en),
    .vpu7_vdiv_clk_en(vpu7_vdiv_clk_en),
    .vpu7_vfdiv_clk_en(vpu7_vfdiv_clk_en),
    .vpu7_vfmis_clk_en(vpu7_vfmis_clk_en),
    .vpu7_vlsu_clk_en(vpu7_vlsu_clk_en),
    .vpu7_vmac_clk_en(vpu7_vmac_clk_en),
    .vpu7_vmask_clk_en(vpu7_vmask_clk_en),
    .vpu7_vpermut_clk_en(vpu7_vpermut_clk_en),
    .vpu7_vsp_clk_en(vpu7_vsp_clk_en),
    .core0_clk(core0_clk),
...
kv_clkdiv #(
    .RATIO(2)
) u_l2c_bank2_data_ram_clkgen (
    .clk_in(l2_clk),
    .resetn(l2_resetn),
    .clk_en(l2c_bank2_data_ram_clk_en),
    .clk_out(l2c_bank2_data_ram_clk)
);
kv_clkdiv #(
    .RATIO(2)
) u_l2c_bank3_data_ram_clkgen (
    .clk_in(l2_clk),
    .resetn(l2_resetn),
    .clk_en(l2c_bank3_data_ram_clk_en),
    .clk_out(l2c_bank3_data_ram_clk)
);
generate
...
endgenerate
generate
    if (COMPLEX_BRG_TYPE == 2 || BIU_ASYNC_SUPPORT == 1) begin:gen_core2_sync
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ) u_debugint2_sync (
            .resetn(core2_reset_n),
            .clk(core2_clk),
            .d(dm_debugint[2]),
            .q(hart2_debugint)
        );
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ) u_resethaltreq2_sync (
            .resetn(core2_reset_n),
            .clk(core2_clk),
            .d(dm_resethaltreq[2]),
            .q(hart2_resethaltreq)
        );
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ...
        kv_sync_l2l #(
            ...
            .clk(aclk),
            .d(hart2_stoptime),
            .q(plmt_hart2_stoptime)
        );
    end
endgenerate
generate
    if (COMPLEX_BRG_TYPE == 2 || BIU_ASYNC_SUPPORT == 1) begin:gen_core3_sync
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ) u_debugint3_sync (
            .resetn(core3_reset_n),
            .clk(core3_clk),
            .d(dm_debugint[3]),
            .q(hart3_debugint)
        );
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ) u_resethaltreq3_sync (
            .resetn(core3_reset_n),
            .clk(core3_clk),
            .d(dm_resethaltreq[3]),
            .q(hart3_resethaltreq)
        );
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ...
        kv_sync_l2l #(
            ...
            .clk(aclk),
            .d(hart3_stoptime),
            .q(plmt_hart3_stoptime)
        );
    end
endgenerate
generate
    if (COMPLEX_BRG_TYPE == 2 || BIU_ASYNC_SUPPORT == 1) begin:gen_core4_sync
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ) u_debugint4_sync (
            .resetn(core4_reset_n),
            .clk(core4_clk),
            .d(dm_debugint[4]),
            .q(hart4_debugint)
        );
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ) u_resethaltreq4_sync (
            .resetn(core4_reset_n),
            .clk(core4_clk),
            .d(dm_resethaltreq[4]),
            .q(hart4_resethaltreq)
        );
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ...
        kv_sync_l2l #(
            ...
            .clk(aclk),
            .d(hart4_stoptime),
            .q(plmt_hart4_stoptime)
        );
    end
endgenerate
generate
    if (COMPLEX_BRG_TYPE == 2 || BIU_ASYNC_SUPPORT == 1) begin:gen_core5_sync
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ) u_debugint5_sync (
            .resetn(core5_reset_n),
            .clk(core5_clk),
            .d(dm_debugint[5]),
            .q(hart5_debugint)
        );
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ) u_resethaltreq5_sync (
            .resetn(core5_reset_n),
            .clk(core5_clk),
            .d(dm_resethaltreq[5]),
            .q(hart5_resethaltreq)
        );
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ...
        kv_sync_l2l #(
            ...
            .clk(aclk),
            .d(hart5_stoptime),
            .q(plmt_hart5_stoptime)
        );
    end
endgenerate
generate
    if (COMPLEX_BRG_TYPE == 2 || BIU_ASYNC_SUPPORT == 1) begin:gen_core6_sync
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ) u_debugint6_sync (
            .resetn(core6_reset_n),
            .clk(core6_clk),
            .d(dm_debugint[6]),
            .q(hart6_debugint)
        );
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ) u_resethaltreq6_sync (
            .resetn(core6_reset_n),
            .clk(core6_clk),
            .d(dm_resethaltreq[6]),
            .q(hart6_resethaltreq)
        );
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ...
        kv_sync_l2l #(
            ...
            .clk(aclk),
            .d(hart6_stoptime),
            .q(plmt_hart6_stoptime)
        );
    end
endgenerate
generate
    if (COMPLEX_BRG_TYPE == 2 || BIU_ASYNC_SUPPORT == 1) begin:gen_core7_sync
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ) u_debugint7_sync (
            .resetn(core7_reset_n),
            .clk(core7_clk),
            .d(dm_debugint[7]),
            .q(hart7_debugint)
        );
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
        ) u_resethaltreq7_sync (
            .resetn(core7_reset_n),
            .clk(core7_clk),
            .d(dm_resethaltreq[7]),
            .q(hart7_resethaltreq)
        );
        kv_sync_l2l #(
            .RESET_VALUE(1'b0),
            .SYNC_STAGE(SYNC_STAGE)
